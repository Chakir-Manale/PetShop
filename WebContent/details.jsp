		...
		<div class="center_content">
			<div class="left_content">
				<div class="crumb_nav">
					...
					<%=prods.get(id).getName()%>
				</div>
				<div class="title">
					<span class="title_icon"><img
						src="resources/images/bullet1.gif" alt="" title="" /></span><%=prods.get(id).getName()%>
				</div>

				<div class="feat_prod_box_details">

					<div class="prod_img">
						<a href="#"><img src="<%=prods.get(id).getImage()%>"
							alt="" title="" border="3" /></a> <br /> <br /> <a
							href="<%=prods.get(id).getImage()%>" rel="lightbox"><img
					...
					<div class="prod_det_box">
						...
						<div class="box_center">
							...
							<p class="details">
								<%=prods.get(id).getDetails()%>
							</p>
							<div class="price">
								<strong>PRICE:</strong> <span class="red"><%=prods.get(id).getPrice()%></span>
							</div>
							<div class="price">
								<strong>COLOR:</strong> <span class="colors"><%=prods.get(id).getColor()%></span>
							</div>
							<a href="cart.jsp?idproduct=<%=prods.get(id).getId()%>" class="more"><img
				...
				<div id="demo" class="demolayout">
					...
					<div class="tabs-container">
						<div style="display: block;" class="tab" id="tab1">
							<p class="more_details"><%=prods.get(id).getDetails()%></p>
						</div>
						...
						<div style="display: none;" class="tab" id="tab2">
							<%
								...
								for (int i = 0; i < prods.size(); i++) {
									if (prods.get(i).getType().equals(prods.get(id).getType()) && i != id) {
							%>
